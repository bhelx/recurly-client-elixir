defmodule Recurly.Webhooks.RenewedSubscriptionNotificationTest do
  ...
  test "correctly parses payload" do
    ...
    notification = %Webhooks.RenewedSubscriptionNotification{} = Webhooks.parse(xml_doc)
    ...
    assert plan.plan_code == "bootstrap"
  end
end
